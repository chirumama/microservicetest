...
namespace MicroserviceHub.API.Application.Interfaces
{
    public interface IApplicationService
    {
        ...
        Task<MicroserviceWithRoutesDto>  GetMicroserviceRoutesAsync(int appId, int microserviceId);
        Task         UpdateRouteAccessAsync(int appId, int microserviceId, UpdateRouteAccessRequest request);
    }
}